#!/usr/bin/env python3
"""SCP AdminController.php to server."""
...
LOCAL_FILE  = "/home/user/Documents/Projects/Rurubene2/backend/app/Http/Controllers/AdminController.php"
REMOTE_FILE = "/var/www/rurubene2/backend/app/Http/Controllers/AdminController.php"
...
run(
    ...
    "Uploading AdminController.php via SCP"
)
print("\n=== Done ===")
