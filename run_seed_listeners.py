#!/usr/bin/env python3
"""
One-shot script: SCP seed_listeners.php to server and execute it via SSH.
...
USER = "root"
PASS = "!m3n@!k@!"
LOCAL_SCRIPT = "/home/user/Documents/Projects/Rurubene2/seed_listeners.php"
REMOTE_SCRIPT = "/tmp/seed_listeners.php"


def run_ssh_command(cmd_list, desc="command"):
    """Run an SSH-like command with password auth via pty."""
    print(f"\n--- {desc} ---")
    pid, fd = pty.fork()
    if pid == 0:
        try:
